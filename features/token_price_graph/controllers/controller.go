...
import (
	...
	"safebsc/features/token_price_graph/models"
	"safebsc/mongo"
...
func (u Controller) GetTokenPriceGraph(c *gin.Context) {
	getTokenPriceGraph(c)
}
...
func calculateForGraph(tokenPrices []*models.TokenPrice) []models.Response {
	...
	for i := 0; i < len(tokenPrices); i++ {
		...
		price = []models.TokenPrice{*tokenPrices[i-1], *tokenPrices[i]}
...
func findHighAndLow(tokenPrices []models.TokenPrice) (highString string, lowString string) {
...
func getTokenPriceGraph(c *gin.Context) {
