...
import (
	...
	"safebsc/features/farm_ratio/models"
...
type FarmRatioController struct{}

func (u FarmRatioController) GetFarmRatio(c *gin.Context) {
	getFarmRatio(c)
}
...
func sumValuePerFarm(userPortfolioLatest []models.UserPortfolioLatests) []models.DataFarmRatio {
	var result []models.DataFarmRatio
	for _, userPort := range userPortfolioLatest {
		...
		if isNewFarm {
			...
			result = append(result, models.DataFarmRatio{
...
func sortAndGroupData(dataFarmRatios []models.DataFarmRatio) ([]models.DataFarmRatio, float64) {
...
func prepareData(supportedFarm []shared.SupportedFarm, dataFarmRatio []models.DataFarmRatio, total float64) models.FarmRatioResponse {
	var data []models.DataFarmRatioResponse
	...
	for i, dataFR := range dataFarmRatio {
		...
		if i == len(dataFarmRatio)-1 {
			data = append(data, models.DataFarmRatioResponse{
	...
	return models.FarmRatioResponse{
		Data: data,
	}
}
