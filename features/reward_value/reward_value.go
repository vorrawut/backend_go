...
func calculateTotalPercent(dataFarmValue []DataInvestmentReportResponse) float64 {
...
func prepareData(totalValue float64, dataInvestmentReports []DataInvestmentReport) InvestmentReportResponse {
